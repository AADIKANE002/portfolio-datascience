...
const ResumeSection = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-space-950/80 backdrop-blur-xl animate-in fade-in">
      <div
        className="relative w-full max-w-4xl h-[90vh] rounded-2xl glass-panel bg-space-900/95 border border-emerald-500/30 shadow-2xl flex flex-col overflow-hidden"
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-space-950/80">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-white">
                Aditya Kumar — Data Scientist Resume
              </h3>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <a
              ...
              download="Aditya_Kumar_Data_Scientist_Resume.pdf"
              onClick={() => soundFx.playSuccess()}
              className="flex items-center gap-1.5 px-3.5 py-2 text-xs sm:text-sm font-bold rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-black shadow-lg shadow-emerald-500/25 transition-all hover:scale-105 active:scale-95"
            >
            ...
            <a
              ...
              download="Aditya_Kumar_Data_Scientist_Resume.docx"
        ...
        <div className="flex-1 bg-space-950 p-2 sm:p-4 overflow-hidden flex flex-col">
          <div className="w-full h-full rounded-xl overflow-hidden border border-white/10 bg-slate-900 relative flex flex-col">
            <iframe
              ...
              title="Aditya Kumar Data Scientist Resume"
            ...
            <div className="p-3 bg-space-900 border-t border-white/10 flex items-center justify-between text-xs text-slate-400">
              <span>Viewing: <strong className="text-slate-200">Aditya_Kumar_Data_Scientist_Resume.pdf</strong></span>
              <a
                href={PERSONAL_INFO.resumePdfUrl}
                target="_blank"
                rel="noreferrer"
