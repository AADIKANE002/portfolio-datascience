      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight">
            Achievements & <span className="bg-gradient-to-r from-emerald-400 via-teal-300 to-amber-400 bg-clip-text text-transparent">Credentials</span>
          </h2>
            ...
            >
              <div>
                <div className="flex items-start justify-between gap-4 mb-4">
                  ...
                  <span className="px-3 py-1 text-xs font-semibold font-mono rounded-full bg-emerald-500/10 text-emerald-300 border border-emerald-500/20">
                    {item.badge}
                  </span>
                </div>

                <div className="text-xl font-bold text-white tracking-tight group-hover:text-emerald-300 transition-colors mb-1">
                  {item.title}
                </div>
            ...
            <div className="glass-panel rounded-2xl p-6 sm:p-8 border border-white/10 bg-space-900/70">
              <div className="flex items-center gap-3 mb-6 pb-4 border-b border-white/10">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Verified credentials in machine learning, GenAI, and cloud architecture</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {CERTIFICATIONS.map((cert, idx) => (
                  <div
                    key={idx}
                    className="p-4 rounded-xl bg-space-950/80 border border-white/5 hover:border-emerald-500/30 transition-all group"
                  >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="glass-panel rounded-2xl p-6 sm:p-8 border border-white/10 bg-gradient-to-r from-space-900/90 to-space-950/90">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-white/10">
              ...
              <div className="px-5 py-3 rounded-2xl bg-space-950 border border-emerald-500/30 text-center self-start md:self-center">
                <div className="text-xs text-slate-400 font-mono">Cumulative GPA</div>
                <div className="text-2xl font-extrabold text-emerald-400 font-mono">{EDUCATION.gpa}</div>
              </div>
            </div>
